...
The foundation is built: the NestJS MCP server, Postgres and Prisma,
Postgres-backed short-term and long-term memory, an embeddings package, a
pgvector vector-store package, health checks, and memory CRUD MCP tools.
