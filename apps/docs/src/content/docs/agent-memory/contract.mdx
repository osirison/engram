...
> The canonical copy of this contract lives in the repository at
> [`docs/agent-memory-contract.md`](https://github.com/osirison/engram/blob/main/docs/agent-memory-contract.md) —
