...
**Tests**: Include test tasks whenever behavior changes, bug fixes alter
runtime behavior, or public contracts change. If no behavior changes occur,
document why tests are not required.
