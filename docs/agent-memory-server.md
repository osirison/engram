...
> Also published at [engram.events/docs/agent-memory/server/](https://engram.events/docs/agent-memory/server/). This repository copy is canonical — agents read it at runtime.
...
per-profile setup live in [SETUP.md](SETUP.md). Both profiles run on Postgres
