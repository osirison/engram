...
> Also published at [engram.events/docs/agent-memory/contract/](https://engram.events/docs/agent-memory/contract/). This repository copy is canonical — agents read it at runtime.
